...
def get_user_watchlist():
    ...
    return {"message": f"Getting user watchlist {username}"}
...
def get_stock_daily_chart():
    ...
    return {"message": f"daily prices for stock - {stock}"}
...
def get_stock_interday_chart():
    ...
    return {"message": f"interday prices for stock - {stock}"}
...
def get_stock_current_price():
    ...
    return {
        "message": f"current price for stock  - {stock}"
    }
